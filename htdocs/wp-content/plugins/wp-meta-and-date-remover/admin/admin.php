...
<div  class="w-full py-8 px-5 bg-white shadow-sm">
    <div class="flex justify-between">
        ...
        <div class=" text-lg">
            ...
            <?php } ?>
            <span class=" text-gray-700">Version:</span> <span class=" text-gray-800">1.9.7</span>
        </div>
    </div>
</div>
...
&lt;?php } ?&gt;
    ...
    <div class=" w-1/4 p-4 shadow-sm flex flex-col justify-center rounded-sm bg-white">
        ...
        <div class="mt-10 hidden">
            <a target="_blank" href="https://wordpress.org/plugins/apperr/">
            <img class="mb-2" src="<?php echo plugin_dir_url( __FILE__ ) . '/img/apperr.svg' ?>">
            <label><span class="text-lg">Apperr App</span><br>Android and iOS App for your WordPress in minutes</label>
            </a>
        </div>
