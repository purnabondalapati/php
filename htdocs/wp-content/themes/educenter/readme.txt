...
Tags: one-column, two-columns, left-sidebar, right-sidebar, custom-background, custom-colors, custom-header, custom-logo, custom-menu, editor-style, post-formats, sticky-post, theme-options, translation-ready, featured-images, e-commerce, education
...
Educenter theme is translation ready.
...
You can check our Theme features at http://sparklewpthemes.com/wordpress-themes/educenter/

= Where can I find theme demo? =

You can check our Theme Demo at http://demo.sparklewpthemes.com/educenter/
...
* html5shiv https://github.com/aFarkas/html5shiv, Copyright (c) 2014 Alexander Farkas (aFarkas), [MIT, GPLv2](http://opensource.org/licenses/mit-license.html, http://www.gnu.org/licenses/gpl-2.0.html)

* Respond https://github.com/scottjehl/Respond, Copyright (c) 2012 Scott Jehlm, [MIT](http://opensource.org/licenses/mit-license.html)

* Waypoints https://github.com/imakewebthings/waypoints, Copyright (c) 2011-2012 Caleb Troughton, [MIT](http://opensource.org/licenses/mit-license.html)

* Theia Sticky Sidebar https://github.com/WeCodePixels/theia-sticky-sidebar, Copyright 2013-2016 WeCodePixels and other contributors, [MIT](http://opensource.org/licenses/mit-license.html)

* prettyPhoto https://github.com/scaron/prettyphoto, © Copyright, Stephane Caron, [CCv2.5, GPLv2](http://creativecommons.org/licenses/by/2.5/,http://www.gnu.org/licenses/gpl-2.0.html )

* Sticky https://github.com/garand/sticky, Copyright 2014-2016 Anthony Garand, [MIT](http://opensource.org/licenses/mit-license.html)

* lightslider https://github.com/sachinchoolur/lightslider, Copyright (c) 2016 Sachin N, [MIT](http://opensource.org/licenses/mit-license.html)
...
*Image - https://pxhere.com/en/photo/1057541
...
= 1.4.8 23rd Aug 2022  =
* WordPress 6.0.2 Compatible

= 1.4.7 10st Aug 2022  =
* Navigation margin issue fixed


= 1.4.6 28st July 2022  =
* Slider Content Color Option Added
* Minor CSS Update

= 1.4.5 1st July 2022  =
* Slider Controls (speed, autoplay, pager, etc) - Added
* WordPress 6.0 tested
* Minor CSS Update
* LearnPress Plugin Compatible

= 1.4.3 5th May 2022  =
* LearnPress Online Education Course - Child theme support
* WordPress 6.0 tested
* Minor CSS Update
* LearnPress Plugin Compatible

= 1.4.2 20th March 2022  =
** Hello Education Child Theme Support
** Course Section List and Slider View added
** Couse Section Column Option Added

= 1.4.1 13th March 2022  =
** Education Xpert Child Theme Compatible


= 1.4.0 10th March 2022  =
** Team, testimonial, blog slider item option added
** Header CSS Fixed
...
= 1.3.7 1st Jan 2022  =
** WP Event Manager Plugin Compatible[https://wordpress.org/plugins/wp-events-manager/]
** LearnPress Plugin Compatible Issue Fix
** Minor CSS Update
** WP Event Block ON Home Page
...
= 1.3.5 27th Dec 2021  =
** WP Event Manager Plugin Compatible
** Selective Refresh Implemented
** WP Event Section and Page Added

= 1.3.4 20th Dec 2021  =
** Header Default Image

= 1.3.3 15th Dec 2021  =
** Body Class based on slider content 

= 1.3.2 13th Dec 2021  =
** Slider Enable/Disable Body Class Issue Fix
** Child Theme Hello Education Compatible
...
** PHP 8 Compatible Issue Fixed

= 1.2.9 22nd Oct 2021  =
** WordPress 5.8.1 Compatible
** Minor Css Update
** Customizer Compatible with Learn Press Plugin

= 1.2.8 22nd July 2021  =
** WordPress 5.8 Compatible

= 1.2.7 5th Jun 2021  =
** Learn Press Education Child Theme Compatible
** Design Improvement

= 1.2.6 5th April 2021  =
...
= 1.2.5 30th March 2021  =
* Bubble Title Hide/Show toggle issue fixed
* Gallery caption issue fixed


= 1.2.4 29th March 2021  =
** Bubble Title Added for each section
** Slider Animation Change
** Gallery Option Added with Full Width Control, Grid Control and Gap Control
** Minor CSS Update

= 1.2.3 9th Feb 2021  =
** Home page design issue fix
** WordPress 5.6.1 Compatible
** WooCommerce Compatible
** Minor CSS Update

= 1.1.2 18th June 2019  =
