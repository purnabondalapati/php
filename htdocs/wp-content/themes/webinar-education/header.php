...
?>
<?php $webinar_education_icon1 = get_theme_mod( 'lms_education_dashicons_setting_1', 'dashicons dashicons-phone' ); ?>
<?php $webinar_education_icon2 = get_theme_mod( 'lms_education_dashicons_setting_2', 'dashicons dashicons-email' ); ?>
<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'webinar-education' ); ?></a>

<div class="header-box">
	<div class="top-header text-center py-3">
		<div class="container">
			<div class="row">
				<div class="col-lg-7 col-md-4 align-self-center text-md-left text-center">
					<?php if ( get_theme_mod('lms_education_phone_number') ) : ?>
				    	<span class="mr-3"><span class="dashicons dashicons-<?php echo esc_attr( $webinar_education_icon1 ); ?>"></span><?php echo esc_html( get_theme_mod('lms_education_phone_number' ) ); ?></span>
				  	<?php endif; ?>
				  	<?php if ( get_theme_mod('lms_education_email_address') ) : ?>
				    	<span><span class="dashicons dashicons-<?php echo esc_attr( $webinar_education_icon2 ); ?>"></span><?php echo esc_html( get_theme_mod('lms_education_email_address' ) ); ?></span>
				  	<?php endif; ?>
				</div>
			    ...
			    <div class="col-lg-3 col-md-5 align-self-center text-md-right text-center">
			...
			<div class="row">
				...
				<div class="col-lg-7 col-md-10 col-sm-8 col-12 align-self-center">
					<?php if(has_nav_menu('main-menu')){ ?>
						<button class="menu-toggle my-2 p-2" aria-controls="top-menu" aria-expanded="false" type="button">
							<span aria-hidden="true"><?php esc_html_e( 'Menu', 'webinar-education' ); ?></span>
						</button>
				...
				<div class="col-lg-1 col-md-1 col-sm-2 col-6 text-center align-self-center">
					<?php if ( class_exists( 'Woocommerce' ) ) {?>
						<a class="cart-customlocation" href="<?php if(function_exists('wc_get_cart_url')){ echo esc_url(wc_get_cart_url()); } ?>" title="<?php esc_attr_e( 'View Shopping Cart','webinar-education' ); ?>"><i class="fas fa-shopping-cart"></i><p class="cart-item-box"> <?php echo esc_html(wp_kses_data( WC()->cart->get_cart_contents_count() ));?></p></a>
					<?php }?>
				</div>
			</div>
		</div>
